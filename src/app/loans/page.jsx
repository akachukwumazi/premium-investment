...
import { FileText, SearchCheck, LockKeyhole, Landmark, RefreshCcw } from "lucide-react";
import Link from "next/link";

const loanSteps = [
  {
    title: "1. Apply Online",
    content: "Submit your loan request directly through our secure portal. Provide your basic details, outline the loan amount, and state your desired repayment timeframe. The process is fully digital and takes minutes.",
    icon: <FileText className="w-12 h-12 text-black" />
  },
  {
    title: "2. Instant Appraisal",
    content: "Our proprietary risk assessment algorithms evaluate your application instantly. You will receive an immediate preliminary decision outlining your eligible loan terms and competitive interest rates.",
    icon: <SearchCheck className="w-12 h-12 text-black" />
  },
  {
    title: "3. Collateral Lock",
    content: "For secure smart-loans, simply lock your digital assets or investment portfolio as collateral. Your assets remain entirely yours and are safely held in our cold-storage escrow vaults during the duration of the loan.",
    icon: <LockKeyhole className="w-12 h-12 text-black" />
  },
  {
    title: "4. Approval & Disbursement",
    content: "Once collateral is verified, final approval is granted immediately. Funds are disbursed instantly to your Premium Invest wallet, where they can be withdrawn to your local bank or used across the platform.",
    icon: <Landmark className="w-12 h-12 text-black" />
  },
  {
    title: "5. Repayment & Release",
    content: "Choose flexible repayment schedules that work for you. Once the loan and interest are fully repaid, your collateral is instantly unlocked and returned to your available balance without any hidden fees.",
    ...
    <div className="w-full min-h-screen bg-premium-white text-premium-black py-20 pt-32 px-6 md:px-12 lg:px-24 flex flex-col items-center overflow-hidden">
      ...
      >
        <div className="flex flex-col gap-4 text-center items-center">
          ...
          >
            Access capital instantly without liquidating your investments. Our collateralized lending solutions provide liquidity with industry-leading rates and flexibility.
          </motion.p>
        </div>
        ...
        <div className="flex flex-col gap-10 w-full mt-8">
          {loanSteps.map((step, index) => (
            ...
            >
              ...
              <div className="flex-shrink-0 bg-gray-50 p-6 rounded-3xl border border-gray-100 z-10 group-hover:bg-premium-blue group-hover:text-white transition-colors duration-500">
